...
var EnvVars = function () {
    ...
    return _a = /** @class */ (function () {
            function EnvVars() {
                ...
                __runInitializers(this, _DATABASE_URL_extraInitializers);
            }
            return EnvVars;
        }()),
        (function () {
...
function validate(config) {
    var validatedConfig = (0, class_transformer_1.plainToInstance)(EnvVars, config, {
    ...
    if (errors.length > 0) {
        throw new Error("Config validation error: ".concat(errors.toString()));
    }
